...
task send_cos;
begin
    in_out_buf[0] = CorruptHshk({~DATA0,DATA0});
    in_out_buf[1] = 8'b00000000;
        in_out_buf[2] = 8'b11111111;
            in_out_buf[3] = 8'b00011000;
    in_out_buf_ptr = 4;
    SendData;
end
endtask
...
begin
    ...
    XmitBuffer[1] = 8'b0000_0101; // SetAddress rozkaz SET_ADDRESS 05h
...
begin
  ...
  control_OUT(address, 4'b0000, 4, Status);
  status_IN (address, 4'b0000, Status);
end
endtask
